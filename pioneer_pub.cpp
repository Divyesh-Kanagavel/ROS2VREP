...
public:
    ...
    {
    leftpublisher_ = this->create_publisher<std_msgs::msg::Float32>("leftMotorSpeed",10);
    rightpublisher_ = this->create_publisher<std_msgs::msg::Float32>("rightMotorSpeed",10);
